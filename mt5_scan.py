...
print("Signal:", side)
print("Long score:", int(last["long_score"]))
print("Short score:", int(last["short_score"]))
print("Session OK:", bool(last["session_ok"]))

levels = trade_levels(last, cfg["strategy"])
if levels:
    print("Entry:", levels["entry"])
    print("Stop Loss:", levels["stop"])
    print("Take Profit:", levels["target"])
    print("R:R = 1:", levels["rr"])
